...
import { OrderStatus, TabItem } from './types';
...
/** 首页分类 Tab 配置 */
export const CATEGORY_TAB_LIST: TabItem[] = [
  { label: '热门', value: 'hot' },
...
/** 订单列表筛选 Tab 配置 */
export const ORDER_TAB_LIST: TabItem[] = [
  { label: '全部', value: 'all' },
...
/** 管理端订单筛选 Tab 配置 */
export const ADMIN_ORDER_TAB_LIST: TabItem[] = [
  { label: '全部', value: 'all' },
  { label: '开通中', value: 'activating' },
...
/** 搜索排序选项 */
export const SEARCH_SORT_LIST: TabItem[] = [
