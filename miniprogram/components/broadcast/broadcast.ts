...
Component({
  ...
  properties: {
    ...
    dataList: {
      type: Array,
      value: [],
      observer(this: any, value: BroadcastItem[]) {
        this.rebuild(value);
      },
    },
  ...
  pageLifetimes: {
    ...
    show(this: any) {
      if (this.data.visible) this.scheduleNext();
    },
  },
  ...
  methods: {
     ...
     */
    rebuild(this: any, list: BroadcastItem[]) {
      const raw = Array.isArray(list) ? list : [];
      const displayList: DisplayItem[] = raw.map((item) => ({
