...
export function dedupSkusToPackages(skus: SkuInput[]): PackageDescriptor[] {
  const best = new Map<string, PackageDescriptor>();
  ...
  for (const sku of skus) {
    ...
    const candidate: PackageDescriptor = {
...
function isBetterCandidate(a: PackageDescriptor, b: PackageDescriptor): boolean {
